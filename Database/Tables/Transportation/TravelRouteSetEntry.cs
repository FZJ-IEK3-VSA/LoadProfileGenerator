...
namespace Database.Tables.Transportation {
    ...
    [JetBrains.Annotations.NotNull]
            ...
            [JetBrains.Annotations.NotNull] AllItemCollections aic)
        {
            ...
            var route = aic.TravelRoutes.FindById(routeID);
            ...
            var affordanceTag = aic.AffordanceTags?.FindById(affordanceTagID);
            ...
            var timeLimit = aic.TimeLimits.FindById(timeLimitId);
