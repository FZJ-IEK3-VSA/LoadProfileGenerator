...
namespace Database.Tables.Transportation {
    ...
    int chargingStationSetID, double maxChargingPower, [JetBrains.Annotations.NotNull] string connectionString,
            [JetBrains.Annotations.NotNull] string name, [CanBeNull] Site site, [NotNull] StrGuid guid, [CanBeNull] VLoadType gridChargingLoadtype) : base(name, TableName, connectionString, guid)
        {
            _site = site;
