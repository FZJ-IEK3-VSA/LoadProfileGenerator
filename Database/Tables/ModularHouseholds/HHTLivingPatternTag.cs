...
namespace Database.Tables.ModularHouseholds {
    public class HHTLivingPatternTag : DBBase, IJSonSubElement<JsonReference>
    {
        ...
        public HHTLivingPatternTag([CanBeNull] int? pID, [CanBeNull] int? householdTraitID, [CanBeNull] LivingPatternTag tag, [JetBrains.Annotations.NotNull] string connectionString, [JetBrains.Annotations.NotNull] string name, StrGuid guid)
