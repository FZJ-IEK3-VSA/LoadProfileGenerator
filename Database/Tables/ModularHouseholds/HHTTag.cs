...
namespace Database.Tables.ModularHouseholds {
    public class HHTTag : DBBase, IJSonSubElement<JsonReference> {
        ...
        public HHTTag([CanBeNull]int? pID, [CanBeNull] int? householdTraitID, [CanBeNull] TraitTag tag, [JetBrains.Annotations.NotNull] string connectionString, [JetBrains.Annotations.NotNull] string name, [NotNull] StrGuid guid)
