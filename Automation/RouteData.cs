...
namespace Automation
{
    ...
    /// <param name="logsum_util_all">optional data from transport model</param>
    /// <param name="logsum_util_no_car_hh">optional data from transport model</param>
    /// <param name="logsum_util_with_car_hh">optional data from transport model</param>
    /// <param name="logsum_time">optional data from transport model</param>
