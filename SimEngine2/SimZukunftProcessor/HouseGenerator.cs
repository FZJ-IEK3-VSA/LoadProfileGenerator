...
namespace SimEngine2.SimZukunftProcessor {
    ...
    public class HouseGenerator {
        ...
        public static void CreateDistrictDefinition([JetBrains.Annotations.NotNull] string connectionString)
        {
        ...
        public static void ProcessDistrictDefinitionFiles([JetBrains.Annotations.NotNull] DistrictDefinitionProcessingOptions args, [JetBrains.Annotations.NotNull] string connectionString)
        {
