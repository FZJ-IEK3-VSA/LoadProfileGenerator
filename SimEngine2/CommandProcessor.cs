...
using PowerArgs;
using SimEngine2.Calculation;
using SimEngine2.Other;
using SimEngine2.SettlementCalculation;
using SimEngine2.SimZukunftProcessor;
...
namespace SimEngine2 {
    ...
    internal class CommandProcessor {
        ...
        [UsedImplicitly]
        public void Batch([JetBrains.Annotations.NotNull] BatchOptions args) {
        ...
        [UsedImplicitly]
        public void Calculate([JetBrains.Annotations.NotNull] CalculationOptions args) {
            try {
                Logger.Info("Running LoadProfileGenerator Version " + Assembly.GetExecutingAssembly().GetName().Version);
        ...
        [UsedImplicitly]
        public void LaunchParallel([JetBrains.Annotations.NotNull] ParallelLauncher.ParallelLauncherOptions args) {
        ...
        [UsedImplicitly]
        public void List([JetBrains.Annotations.NotNull] ListOptions args) {
        ...
        [UsedImplicitly]
        public void TestBatch([JetBrains.Annotations.NotNull] TestBatchOptions args) {
        ...
        [ArgShortcut("PPD")]
        [UsedImplicitly]
        public void ProcessDistrictDefinitionFiles([JetBrains.Annotations.NotNull] DistrictDefinitionProcessingOptions args)
        {
        ...
        [ArgShortcut("CJ")]
        [UsedImplicitly]
        public void CalculateJson([JetBrains.Annotations.NotNull] JsonDirectoryOptions args)
        {
