...
namespace ReleaseMaker {
    public class SimEngine2Copier : CopierBase {
        public static void CopySimEngine2Files([JetBrains.Annotations.NotNull] string src, [JetBrains.Annotations.NotNull] string dst)
        {
            ...
            Copy(programFiles, srcDi, src, dst, @"api-ms-win-core-console-l1-2-0.dll");
            ...
            Copy(programFiles, srcDi, src, dst, @"mscordaccore_amd64_amd64_5.0.421.11614.dll");
            ...
            Copy(programFiles, srcDi, src, dst, @"System.Diagnostics.EventLog.Messages.dll");
