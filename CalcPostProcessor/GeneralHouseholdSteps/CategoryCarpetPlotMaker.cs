...
namespace CalcPostProcessor.GeneralHouseholdSteps
{
    public class CarpetCategoryEntry {
        public CarpetCategoryEntry([NotNull] TimeStep time, [CanBeNull] string category, Color color, bool addSicknessMarker)
        {
            Time = time;
            Category = category;
            Color = color;
    ...
    public class CategoryCarpetPlotMaker {
        ...
        public CategoryCarpetPlotMaker([NotNull] CalcParameters calcParameters)
        {
        ...
        public void MakeCarpet([NotNull] FileFactoryAndTracker fft,
                                [NotNull] Dictionary<int, CarpetCategoryEntry> carpetCategoryEntries,
                                 TimeSpan officialSimulationDuration, [NotNull] HouseholdKey householdKey,
                                int colwidth, [NotNull] string dstFilename,
                               [NotNull] string fileDescription, int resolutionMultiplier,
                               [NotNull] string legendFilename, [NotNull] string legendDescription,
                               [NotNull] string chartIndex)
        {
        ...
        [ItemNotNull]
        [NotNull]
        private List<Tuple<string, Color>> MakeLegendEntries([NotNull] Dictionary<int, CarpetCategoryEntry> carpetCategoryEntries)
        {
        ...
        private void MakeLegend([NotNull] FileFactoryAndTracker fft,
                                [ItemNotNull] [NotNull] List<Tuple<string, Color>> entries,
                               [NotNull] HouseholdKey householdKey,
                               int resolutionMultiplier, [NotNull] string legendfilename,
                                [NotNull] string legendDescription,
